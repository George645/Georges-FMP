            ...
            if (firstFrameSelected) {
                ...
                if (selected) {
                    if (thisPiece.infinitelyScalingRange) {
                        ...
                        for (int x = -(thisPiece.potentialRange - 1) / 2; x < (thisPiece.potentialRange - 1) / 2; x++) {
                            for (int z = -(thisPiece.potentialRange - 1) / 2; z < (thisPiece.potentialRange - 1) / 2; z++) {
                                if (!thisPiece.PositionIsUnlocked(x, z)) {
